...
<form id="add-club" action="{{ route('venue.edit', ['id' => $venue->id]) }}" method="POST">
    ...
    <p><div class="p-3">
        ...
        <input type="number" id="limit" name="limit" min="0" max="180" value="{{ $venue->schedule_limit }}" class="inline w-16 rounded border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200">天內
