...
<form id="add-roster" action="{{ route('roster.add') }}" method="POST">
    ...
    <p class="p-3">
        ...
        <input class="rounded border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700"
            type="checkbox" name="grades[]" value="{{ $grade->id }}"><span class="text-sm">{{ $grade->name }}　</span>
        @endforeach
    </p>
    <p class="p-3">
        ...
        <input class="rounded border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700"
            type="checkbox" name="fields[]" value="{{ $field['id'] }}"><span class="text-sm">{{ $field['name'] }}　</span>
        @endforeach
    ...
    <p class="p-3">
        ...
        <input class="w-36 rounded px-2 border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200"
            type="date" name="start" value="{{ date('Y-m-d') }}">　到　
        <input class="w-36 rounded px-2 border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200"
            type="date" name="end" value="{{ date('Y-m-d') }}">
    </p>
    <p class="p-3">
        ...
        <input class="w-16 rounded px-2 border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200"
            type="number" name="min" min="1" max="10" value="1" inputmode="numeric">　到　
        <input class="w-16 rounded px-2 border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200"
            type="number" name="max" min="1" max="10" value="1" inputmode="numeric">
