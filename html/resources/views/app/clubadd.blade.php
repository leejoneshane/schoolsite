...
<form id="add-club" action="{{ route('clubs.add') }}" method="POST">
    ...
    <p><div class="p-3">
        ...
        <input type="text" name="total" class="inline w-16 rounded border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200">
    ...
    <p><div class="p-3">
        <label for="location" class="inline">備註：</label>
    ...
    <p><div class="p-3">
        ...
        新台幣<input type="text" name="cash" class="inline w-24 rounded border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200" required>元
    </div></p>
    <p><div class="p-3">
    ...
    <p><div class="p-3">
        <label for="remove" class="inline-flex relative items-center cursor-pointer">
            <input type="checkbox" id="remove" name="remove" value="no" class="sr-only peer">
