...
<form id="upload" action="{{ route('seniority.import') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="p-3">
        ...
        <input type="file" name="excel" accept=".xlsx" class="block text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100" required>
    </div>
    <div class="p-3">
