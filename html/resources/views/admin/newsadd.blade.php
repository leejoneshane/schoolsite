...
<form id="edit-unit" action="{{ route('news.add') }}" method="POST">
    @csrf
    <div class="block">
    ...
    <input class="w-12 rounded px-3 py-2 border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200 hidden"
        type="text" id="day" name="day" pattern="^([1-9]|[12][0-9]|3[01])$">
