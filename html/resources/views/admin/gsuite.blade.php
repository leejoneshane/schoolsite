    ...
    <div class="h-full grid">
        ...
        <div class="w-full border-blue-500 bg-blue-100 dark:bg-blue-700 border-b-2 mb-5" role="alert">
            ...
            <ol class="list-decimal list-inside">
                ...
                <li>搜尋 G Suite 群組的說明(description)欄位是否與資料庫裡的所屬部門名稱相同，若相同則使用該群組，如果找不到則自動幫您建立群組。（如果您已經有一個匹配的 G Suite
                    群組，請在說明欄輸入部門名稱，以便讓程式可以正確辨識）</li>
                <li>搜尋 G Suite 群組的說明(description)欄位是否與資料庫裡的所屬職務名稱相同，若相同則使用該群組，如果找不到則自動幫您建立群組。（如果您已經有一個匹配的 G Suite
                    群組，請在說明欄輸入職務名稱，以便讓程式可以正確辨識）</li>
                <li>搜尋 G Suite 群組的說明(description)欄位是否與資料庫裡的隸屬領域名稱相同，若相同則使用該群組，如果找不到則自動幫您建立群組。（如果您已經有一個匹配的 G Suite
                    群組，請在說明欄輸入領域名稱，以便讓程式可以正確辨識）</li>
            ...
            <div class="h-full grid grid-cols-2 grid-flow-col gap-3">
                ...
                <div class="col-span-1">
                    <div id="target1" class="p-2">
                        ...
                        <select
                            class="inline rounded w-40 px-3 py-2 border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200"
                            name="target1">
                    ...
                    <div id="target2" class="p-2 hidden">
                        ...
                        <select
                            class="inline rounded w-20 px-3 py-2 border border-gray-300 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none active:outline-none dark:border-gray-400 dark:focus:border-blue-600 dark:focus:ring-blue-600  bg-white dark:bg-gray-700 text-black dark:text-gray-200"
                            name="target2">
                            @php
                                $syear = date("Y") - 1917;
                                $eyear = $syear - 5;
