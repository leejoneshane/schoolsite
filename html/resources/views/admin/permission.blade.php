...
<div class="relative m-5">
    <div class="p-10">
        ...
        <form id="edit-class" action="{{ empty($current) ? route('menus') : route('menus', ['menu' => $current]) }}" method="POST">
            @csrf
            <table class="w-full py-4 text-left font-normal">
                ...
                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-gray-700 dark:even:bg-gray-600">
                    ...
                    @endif
                    <td class="p-2">
                        <select id="kind_{{ $m->id }}" class="form-select w-24 m-0 px-3 py-2 text-base font-normal transition ease-in-out rounded border border-gray-300 dark:border-gray-400 bg-white dark:bg-gray-700 text-black dark:text-gray-200"
                    ...
                    @endif
                    <td class="p-2">
                        <a class="text-sm py-2 px-6 rounded text-blue-300 hover:text-blue-600" href="{{ empty($current) ? route('menus.add') : route('menus.remove', ['menu' => $i->id]) }}">
