        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-blue-700">
            ...
            <div class="p-2 text-base leading-relaxed text-gray-500 dark:text-gray-400">
                ...
                <div class="w-full inline-flex justify-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button onclick="remove_task();" type="button" class="ms-3 text-white bg-red-700 hover:bg-bred-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                        刪除
                    </button>
