...
<div class="text-2xl font-bold leading-normal pb-5 drop-shadow-md">
    編輯據點
    <a class="text-sm py-2 pl-6 rounded text-blue-500 hover:text-blue-600" href="{{ route('game.bases') }}">
        <i class="fa-solid fa-eject"></i>返回上一頁
    </a>
</div>
<form id="add-class" action="{{ route('game.base_edit', [ 'base_id' => $base->id ]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <p><div class="p-3">
