...
<div class="text-2xl font-bold leading-normal pb-5">
    怪物一覽表
    <a class="text-sm py-2 pl-6 rounded text-blue-300 hover:text-blue-600" href="{{ route('game.monster_add') }}">
        <i class="fa-solid fa-circle-plus"></i>新增怪物
    </a>
</div>
