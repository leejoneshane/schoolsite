    ...
    <div class="w-full border-blue-500 bg-blue-100 dark:bg-blue-700 border-b-2 mb-5" role="alert">
        ...
        <p>
            <ul class="list-decimal list-inside">
                ...
                <li class="list-item">若您是家長，您可以綁定自己的社群帳號（代理登入貴子弟的帳號），以避免修改教育局單一身份驗證的密碼。</li>
                <li class="list-item">若您是學生，請不要綁定非法申請的社群帳號（未滿 13 歲無法申請之帳號，例如：facebook、line），以免觸犯法律規定。</li>
                <li class="list-item">每種社群平台只能綁定一個帳號，若您有多個小孩就讀本校，請綁定不同社群平台的帳號。若要變更已經綁定的社群帳號，請先解除綁定後再重新設定！</li>
            </ul>
        </p>  
    </div>
