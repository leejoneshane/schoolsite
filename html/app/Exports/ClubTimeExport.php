...
class ClubTimeExport
{
    ...
    public function export($title, $filename, $type)
    {
        ...
        $section->addText($club->name.'　　指導老師簽名：　　　　　　', ['bold' => true, 'size' => 14], ['alignment' => 'center', 'lineHeight' => 1]);
        ...
        $table->addCell(Converter::cmToTwip(5), ['gridSpan' => 3,'bgColor' => 'cccccc', 'valign' => 'center'])
            ->addText('課後與社團活動一覽表', ['bold' => true], ['alignment' => 'right']);
