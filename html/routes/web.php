...
Route::group(['prefix' => 'game', 'middleware' => ['auth']], function () {
    ...
    Route::get('skills/list/{type?}/{id?}', 'App\Http\Controllers\Game\SkillController@index')->name('game.skills');
    ...
    Route::get('evaluates', 'App\Http\Controllers\Game\DungeonController@evaluates')->name('game.evaluates');
    Route::get('evaluate/add', 'App\Http\Controllers\Game\DungeonController@evaluate_add');
    Route::post('evaluate/add', 'App\Http\Controllers\Game\DungeonController@evaluate_insert')->name('game.evaluate_add');
    Route::get('evaluate/edit/{evaluate_id}', 'App\Http\Controllers\Game\DungeonController@evaluate_edit');
    ...
    Route::post('question/remove', 'App\Http\Controllers\Game\DungeonController@question_remove')->name('game.question_remove');
    Route::post('question/answer', 'App\Http\Controllers\Game\DungeonController@question_answer')->name('game.question_answer');
    Route::post('option/add', 'App\Http\Controllers\Game\DungeonController@option_insert')->name('game.option_add');
    Route::post('option/edit', 'App\Http\Controllers\Game\DungeonController@option_update')->name('game.option_edit');
    Route::post('option/remove', 'App\Http\Controllers\Game\DungeonController@option_remove')->name('game.option_remove');
    Route::get('evaluate/assign/{evaluate_id}', 'App\Http\Controllers\Game\DungeonController@evaluate_assign')->name('game.evaluate_assign');
    Route::get('dungeon/add/{evaluate_id}', 'App\Http\Controllers\Game\DungeonController@dungeon_add');
    Route::post('dungeon/add/{evaluate_id}', 'App\Http\Controllers\Game\DungeonController@dungeon_insert')->name('game.dungeon_add');
    Route::get('dungeon/edit/{dungeon_id}', 'App\Http\Controllers\Game\DungeonController@dungeon_edit');
    Route::post('dungeon/edit/{dungeon_id}', 'App\Http\Controllers\Game\DungeonController@dungeon_update')->name('game.dungeon_edit');
    Route::post('dungeon/remove/{dungeon_id}', 'App\Http\Controllers\Game\DungeonController@dungeon_remove')->name('game.dungeon_remove');
    Route::get('worksheets', 'App\Http\Controllers\Game\AdventureController@worksheets')->name('game.worksheets');
    Route::get('worksheet/add', 'App\Http\Controllers\Game\AdventureController@worksheet_add');
    Route::post('worksheet/add', 'App\Http\Controllers\Game\AdventureController@worksheet_insert')->name('game.worksheet_add');
    Route::get('worksheet/edit/{worksheet_id}', 'App\Http\Controllers\Game\AdventureController@worksheet_edit');
    ...
    Route::get('dungeons', 'App\Http\Controllers\Game\DungeonController@dungeons')->name('game.dungeons');
    Route::get('dungeons/answers/{dungeon_id}', 'App\Http\Controllers\Game\DungeonController@answers')->name('game.answers');
    Route::post('dungeons/answers/remove/{answer_id}', 'App\Http\Controllers\Game\DungeonController@answer_remove')->name('game.answer_remove');
    Route::get('dungeons/answers/journeys/{answer_id}', 'App\Http\Controllers\Game\DungeonController@journeys')->name('game.journeys');
    //學生初始設定
