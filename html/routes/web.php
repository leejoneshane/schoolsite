...
Route::get('calendar/event/remove/{event}', 'App\Http\Controllers\CalendarController@eventRemove')->middleware('auth')->name('calendar.removeEvent');
...
Route::group(['prefix' => 'club', 'middleware' => [ 'auth' ] ], function () {
    ...
    Route::get('enroll/add/{club_id}', 'App\Http\Controllers\ClubController@clubEnroll');
    Route::post('enroll/add/{club_id}', 'App\Http\Controllers\ClubController@clubEnroll')->name('clubs.addenroll');
    Route::get('enroll/edit/{enroll_id}', 'App\Http\Controllers\ClubController@clubEnroll');
    Route::post('enroll/edit/{enroll_id}', 'App\Http\Controllers\ClubController@clubEnroll')->name('clubs.editenroll');
    Route::post('enroll/remove/{enroll_id}', 'App\Http\Controllers\ClubController@clubEnroll')->name('clubs.delenroll');
...
Route::group(['prefix' => 'admin', 'middleware' => [ 'auth', 'admin' ] ], function () {
    ...
    Route::get('database/teachers/{uuid}/remove', 'App\Http\Controllers\Admin\SchoolDataController@teacherRemove')->name('teachers.remove');
    ...
    Route::get('database/students/{uuid}/remove', 'App\Http\Controllers\Admin\SchoolDataController@studentRemove')->name('students.remove');
    ...
    Route::get('website/menus/remove/{menu}', 'App\Http\Controllers\Admin\MenuController@remove')->name('menus.remove');
    ...
    Route::get('website/permission/{id}/remove', 'App\Http\Controllers\Admin\PermitController@remove')->name('permission.remove');
